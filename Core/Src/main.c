...
/* USER CODE BEGIN PFP */
static void on_espuart_data(uint8_t *data, uint16_t length);
/* USER CODE END PFP */
...
int main(void)
{
  ...
  espuart_init(&huart2, &hdma_usart2_rx, on_espuart_data);
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_2|OTG_FS_PowerSwitch_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, GPIO_PIN_12|GPIO_PIN_13, GPIO_PIN_RESET);

  /*Configure GPIO pins : PC2 OTG_FS_PowerSwitch_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_2|OTG_FS_PowerSwitch_Pin;
